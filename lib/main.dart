...
import 'package:bleperipharal/utility/permissionble.dart';
...
class FlutterBlePeripheralExampleState
  ...
  PersmissionBle persmissionBle = PersmissionBle();

  final AdvertiseData advertiseData = AdvertiseData(

    serviceUuid: '76f03107-fe47-46c1-ab3b-f72ec15d0297',
  );
  ...
  Future<void> _toggleAdvertise() async {
    if (await blePeripheral.isAdvertising) {
      ...
      await persmissionBle.getLocationPermission();
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('BLE Peripheral APP'),
        ),
        body: Center(
          child: Column(
